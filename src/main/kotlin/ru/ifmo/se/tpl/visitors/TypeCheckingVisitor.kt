...
class TypeCheckingVisitor(val programScope: Scope): ASTVisitor() {
...
//            throw ProcedureAlreadyExistsException("Procedure already defined: ${declaration.name}${declaration.parameters.map { it.type }}")
//
        currentScope = currentScope.enterNext()
